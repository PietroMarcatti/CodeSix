...
export class MenuVM{
    ...
    modalIsOpen = false;
    id=-1;
    names=["Carica dati da CSV", "Gestisci Sessione", "Riduzione Dimensionale","Calcolo delle distanze", "Scatterplot Matrix", "Sankey Diagram", "Force Directed Field", "Parallell Coordinates"];
